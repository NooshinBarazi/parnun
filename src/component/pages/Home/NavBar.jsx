  ...
  return (
    <div>
      <nav className="container mx-auto">
        {/* Flex Container */}
        <div className="flex justify-between bg-white shadow shadow-3xl">
            ...
            <div className="left_side flex">
                <div className="call flex items-center">
                    ...
                    <div className="tell flex flex-col text-secondary text-[18px] ml-4">
                        <span className='opacity-50 flex justify-start font-bold'>021</span>
            ...
            {/* Right Side */}
            <div className="logo flex flex-row-reverse">
                <LogoIcon />
